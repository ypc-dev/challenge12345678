...
def get_all_sensors(
  ...
  """
  sensors = services.get_all_sensors(db=db, limit=limit)
  return sensors
...
def get_weatherdata_by_sensor(
  ...
  return services.get_weatherdata_by_sensor(db=db, sensor_id=sensor_id, day_range=day_range, limit=limit)
...
def get_all_weatherdata(
  ...
  """
  all_weatherdata = services.get_all_weatherdata(db=db, day_range=day_range, limit=limit)
